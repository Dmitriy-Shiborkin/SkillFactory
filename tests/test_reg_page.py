...
def test_firstname_field_rp_15_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Вовавовавовавов')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_firstname_field_rp_30_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Вовавовавовавовавовавовавоваво')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_firstname_field_rp_31_cor_sym(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Вовавовавовавовавовавовавовавов')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.click()
...
def test_email_field_rp(driver):
    ...
    email.clear()
    email.send_keys('xehosox130@khaxan.com')
...
def test_pass_field_rp(driver):
    ...
    password = driver.find_element(By.ID, 'password')
    password.clear()
    password.send_keys('aLYknhtfE!Z!L7G')
...
def test_pass_con_field_rp(driver):
    ...
    pass_con = driver.find_element(By.ID, 'password-confirm')
    pass_con.clear()
    pass_con.send_keys('aLYknhtfE!Z!L7G')
    password = driver.find_element(By.ID, 'password')
    password.click()
...
def test_reg_page_cor_data(driver):
    ...
    firstname = driver.find_element(By.NAME, 'firstName')
    firstname.clear()
    firstname.send_keys('Вл-А')
    lastname = driver.find_element(By.NAME, 'lastName')
    lastname.clear()
    lastname.send_keys('Дими-Р')
    email = driver.find_element(By.ID, 'address')
    email.clear()
    email.send_keys('xehosox130@khaxan.com')
    password = driver.find_element(By.ID, 'password')
