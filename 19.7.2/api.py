...
class PetFriends:
    ...
    def get_list_of_pets(self, auth_key: json, filter: str = "") -> json:
       ...
       со списком найденных питомцев, совпадающий с фильтром. На данный момент фильтр может иметь
    ...
    def delete_pet(self, auth_key: json, pet_id: str) -> json:
        ...
        результат в формате JSON с текстом уведомления об успешном удалении. На сегодняшний день тут есть баг -
    ...
    def update_pet_info(self, auth_key: json, pet_id: str, name: str, animal_type: str, age: int) -> json:
        """Метод отправляет запрос на сервер об обновлении данных питомуа по указанному ID и возвращает
